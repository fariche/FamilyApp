...
export class AuthService {
  ...
  doChangeProfilePicture(imageURI){
    return new Promise<any>((resolve, reject) => {
  ...
  //we must transform the URI into a base64 URL. To do so, we created the
  // following function that we called from the previous function uploadImage()
